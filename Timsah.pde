class Timsah{
  ...
  //4 yöne hareket olsun.
  
  Timsah(int kareX, int kareY){
    this.kareX = kareX;
    this.kareY = kareY;
    this.resimTimsah = loadImage("data/timsah.png");
  ...
  void draw(){
    hareket();
    pushMatrix();
      image(resimTimsah,this.konumX,this.konumY);
    popMatrix();
  }
